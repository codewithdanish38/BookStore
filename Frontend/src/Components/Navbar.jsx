...
const Navbar = () => {
  ...
  return (
    <div>
      <div className={`navbar bg-base-100 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition ease-in-out" : ""}`}>
        ...
        <div className="navbar-end flex items-center justify-end w-full lg:w-auto">
          <ul className="menu menu-horizontal px-1 font-poppins lg:hidden">
            <li><a href="/">Home</a></li>
            <li><a href="/course">Course</a></li>
            <li><a href="/contact">Contact</a></li>
            <li><a href="/about">About</a></li>
          ...
          {/* Login button */}
          <button className="btn btn-secondary m-6" onClick={() => document.getElementById("my_modal_1").showModal()}>
            Login
          </button>
        </div>
      </div>
